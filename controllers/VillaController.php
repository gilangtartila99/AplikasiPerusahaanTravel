...
/**
 * VillaController implements the CRUD actions for Villa model.
 */
class VillaController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_villa]);
        } else {
    ...
    /**
     * Updates an existing Villa model.
    ...
    /**
     * Deletes an existing Villa model.
