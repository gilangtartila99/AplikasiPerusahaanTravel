...
?>
    ...
    <p>
        ...
        <?php $data = 
         ...
         '15' => '15 Malam']; ?>
        <div class="col-lg-4">
            <?= $form->field($model, 'jumlah_hari')->dropDownList($data, ['prompt'=>'Jumlah Hari','class' => 'textbox']); ?>
        </div>
...
?>  
    ...
    <?php if(Yii::$app->user->getIsGuest()) { ?>
        <?php $data = 
             ['Pakai Supir' => 'Pakai Supir',
             'Tidak Pakai Supir' => 'Tidak Pakai Supir',]; ?>
        <?php echo $form->field($model, 'jenis_kelamin')->dropDownList($data, ['prompt'=>'Pilih Fasilitas','class' => 'textbox']); ?>

        <?php echo $form->field($model, 'nama')->textInput(['class' => 'textbox']) ?>

        <?php echo $form->field($model, 'no_identitas')->textInput(['class' => 'textbox']) ?>

        <?php $data = 
             ['Laki - Laki' => 'Laki - Laki',
             'Perempuan' => 'Perempuan',]; ?>
        <?php echo $form->field($model, 'jenis_kelamin')->dropDownList($data, ['prompt'=>'Pilih Jenis Kelamin','class' => 'textbox']); ?>

        <?php echo $form->field($model, 'alamat')->textArea(['class' => 'textbox', 'rows' => 6]) ?>
    <?php } else { echo ''; } ?>
...
<div class="col-lg-6">
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'label' => 'Gambar',
                'value' => Html::img("uploads/mobil/".$mobil->gambar, ['width' => '200px']),
                'format' => 'raw'
            ],
            'plat_nomor',
            'tipe_mobil',
            ...
            [
                'label' => 'Harga',
                'value' => Yii::$app->formatter->asCurrency($mobil->harga),
            ],
        ],
    ]) ?>
</div>
