...
?>  
    ...
    <div class="form-group">
        <center><?= Html::submitButton($model->isNewRecord ? 'Pesan Sekarang' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-primary' : 'btn btn-primary']) ?>
        </center>
    </div>
...
<div class="col-lg-6">
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'label' => 'Gambar',
                'value' => Html::img("uploads/villa/".$villa->gambar, ['width' => '200px']),
                'format' => 'raw'
            ],
            'tipe_villa',
            'nama_villa',
            ...
            [
                'label' => 'Harga',
                'value' => Yii::$app->formatter->asCurrency($villa->harga),
            ],
        ],
    ]) ?>
</div>
