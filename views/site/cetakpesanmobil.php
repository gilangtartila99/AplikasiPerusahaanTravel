...
$kode = $model->id_pesan_mobil;
$mobil = $model->mobil['pabrikan_mobil'] . ' ' . $model->mobil['jenis_mobil'];
$checkin = $model->tanggal_mulai;
$checkout = $model->tanggal_akhir;
$malam = $model->jumlah_hari. ' Malam';
$harga = Yii::$app->formatter->asCurrency($model->mobil['harga']*$model->jumlah_hari);
$nama = $model->nama;
//$status = $model->STATUS;
...
//$telp = $model->NO_TELP;
//$email = $model->EMAIL;
$gambarhotel = $model->mobil['gambar'];
