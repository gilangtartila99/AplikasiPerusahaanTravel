...
$kode = $model->id_pesan_villa;
$villa = $model->villa['nama_villa'];
$checkin = $model->tanggal_mulai;
$checkout = $model->tanggal_akhir;
$malam = $model->jumlah_hari. ' Malam';
$harga = Yii::$app->formatter->asCurrency($model->villa['harga']*$model->jumlah_hari);
$nama = $model->nama;
//$status = $model->STATUS;
...
//$telp = $model->NO_TELP;
//$email = $model->EMAIL;
$gambarhotel = $model->villa['gambar'];
...
<table class="table table-striped" border="3" width="100%">
  ...
  <tbody>
    <tr>
      <th><?= Html::img("uploads/mobil/".$model->villa['gambar'], ['width' => '100px']) ?></th>
      <td>
        <p><b><?= $villa ?></b></p>
